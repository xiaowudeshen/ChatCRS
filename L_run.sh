...
#PBS -q normal
#PBS -o log/LLAMA2-TUE-CRS-C-G.log
...
# python ChatCRS.py --config configs/CHATCRS_DuE_CRS.yaml  --model LLAMA2 --huggingface_key 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 --save_dir result_L
# python ChatCRS.py --config configs/CHATCRS_DuE_CRS_GOAL.yaml  --model LLAMA2 --huggingface_key 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  --save_dir result_L
# python ChatCRS.py --config configs/CHATCRS_DuE_CRS_REC.yaml  --model LLAMA2 --huggingface_key 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 --save_dir result_L
