...
#PBS -q normal
#PBS -o log/LLAMA2-Fri-CRS-rec.log
...
# python ChatCRS.py --config configs/CHATCRS_DuE_CRS_GOAL.yaml  --model LLAMA2 --huggingface_key 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
python ChatCRS.py --config configs/CHATCRS_DuE_CRS_REC.yaml  --model LLAMA2 --huggingface_key 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
# python ChatCRS.py --config configs/CHATCRS_DuE_CRS_TOPIC.yaml  --model LLAMA2 --huggingface_key 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
