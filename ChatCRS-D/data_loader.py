...
def prepare_train_data(args):
    ...
    if (args.task == 'CRS' or args.task == 'REC') and args.with_guidance:
        out_path = os.path.join('data_train', args.dataset_name + '_' + args.task + '_' + args.guidance + '.json') 
    else:  
        out_path = os.path.join('data_train', args.dataset_name + '_' + args.task + '.json')
...
def prepare_dev_data(args):
    ...
    if args.dataset_name == "DuRecDial_ENGLISH":
        ...
        data_path = os.path.join('data_p/tgredial', 'tg_dev.json')
    # elif args.dataset_name == "OpenKnowKG":
    #     data_path = os.path.join('data_p/opendialkg', 'opendialkg.json')
    # elif args.dataset_name == "ReDial":
    ...
    if not os.path.exists('data_dev'):
        os.makedirs('data_dev')
    if (args.task == 'CRS' or args.task == 'REC') and args.with_guidance:
        out_path = os.path.join('data_dev', args.dataset_name + '_' + args.task + '_' + args.guidance + '.json') 
    else:  
        out_path = os.path.join('data_dev', args.dataset_name + '_' + args.task + '.json')
    eval_data = read_data(data_path, out_path, args)
