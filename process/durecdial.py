...
class Durecdial():
    def __init__(self, durecdial_path):
        ...
        self.train_dialogs = self.txt_to_json(os.path.join(self.path, "en_train.txt"), os.path.join(self.path, "du_en_train.json"), os.path.join(self.path1, "du_en_train_knowledge.json"), action = "train")
        self.train_dialogs = self.txt_to_json(os.path.join(self.path, "zh_train.txt"), os.path.join(self.path, "du_zh_train.json"), os.path.join(self.path1, "du_zh_train_knowledge.json"), action = "train")
        # self.dev_dialogs = self.txt_to_json(os.path.join(self.path, "en_dev.txt"), os.path.join(self.path, "du_en_dev.json"), os.path.join(self.path1, "du_en_dev_knowledge.json"), action = "dev")
        # self.dev_dialogs = self.txt_to_json(os.path.join(self.path, "zh_dev.txt"), os.path.join(self.path, "du_zh_dev.json"), os.path.join(self.path1, "du_zh_dev_knowledge.json"), action = "dev")
        # self.test_dialogs = self.txt_to_json(os.path.join(self.path, "en_test.txt"), os.path.join(self.path, "du_en_test.json"), os.path.join(self.path1, "du_en_test_knowledge.json"), action = "test")
        # self.test_dialogs = self.txt_to_json(os.path.join(self.path, "zh_test.txt"), os.path.join(self.path, "du_zh_test.json"), os.path.join(self.path1, "du_zh_test_knowledge.json"), action = "test")
            ...
            for  turn in single_dialog["conversation"]:
                if action == "train":
                    turn_dict = {
                        ...
                        "goal": single_dialog["goal_type_list"][turn_id], #string
                        "topic": single_dialog["goal_topic_list"][turn_id], #string
                        ...
                        "mention": [] #not applicable for DuRecDial
                    }
                else:
                    turn_dict = {
                        "role": next_role, #string, seeker/recommender
